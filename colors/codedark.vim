...
let s:cdDiffRedLight = {'gui': '#875f00', 'cterm': s:cterm08, 'cterm256': '94'}
let s:cdDiffRedLightLight = {'gui': '#FB0101', 'cterm': s:cterm08, 'cterm256': '09'}
let s:cdDiffGreenDark = {'gui': '#373D29', 'cterm': s:cterm0B, 'cterm256': '237'}
let s:cdDiffGreenLight = {'gui': '#005f00', 'cterm': s:cterm09, 'cterm256': '22'}
...
call <sid>hi('DiffChange', {}, s:cdSearchCurrent, 'none', {})
call <sid>hi('DiffDelete', {}, s:cdDiffRedDark, 'none', {})
...
hi DiffDelete ctermfg=188 guifg=#d4d4d4
